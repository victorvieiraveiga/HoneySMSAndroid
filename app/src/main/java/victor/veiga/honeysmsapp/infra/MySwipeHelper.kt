...
abstract class MySwipeHelper(context: Context, private val recyclerView :RecyclerView,
    ...
    abstract  fun initiateMyButton(viewHolder: RecyclerView.ViewHolder, buffer: MutableList<MyButton>)
    ...
    private fun drawbutton(c: Canvas, itemView: View, buffer: MutableList<MyButton>, pos: Int, translatioX: Float) {
